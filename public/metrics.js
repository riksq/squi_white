...
<!-- End Google Tag Manager -->'; // Заменить на код, который даёт гугл для вставки в <head>
...
<!-- End Google Tag Manager (noscript) -->'; // Заменить на код, который даёт гугл для вставки в <body>
